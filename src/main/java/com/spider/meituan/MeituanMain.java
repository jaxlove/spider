...
//        insertShop();
    ...
    public static Map<String, Object> getDetail(Long shopId, String url) throws Exception {
        ...
        Object avg = JXDocumentUtil.getInfoByJXDocument(jxDocument, "//div[@class='rating']/span[@class='avg-price']/text()");
        Object addressMap = JXDocumentUtil.getInfoByJXDocument(jxDocument, "//h6[@class='address-block']/a[@class='react']/@href");
        Object address = JXDocumentUtil.getInfoByJXDocument(jxDocument, "//h6[@class='address-block']/a[@class='react']/div[@class='poi-address']/text()");
        Object phone = JXDocumentUtil.getInfoByJXDocument(jxDocument, "//div/p/a[@data-com='phonecall']/@data-tele");
        List<Element> courseList = JXDocumentUtil.getList(jxDocument, "//dl[@class='list']//dl[@class='list bd-deal-list']//dd");
        Object commentUrl = JXDocumentUtil.getInfoByJXDocument(jxDocument, "//dd[@class='buy-comments db']/a[@class='react']/@href");
        ...
        if (courseList != null && !courseList.isEmpty()) {
            for (Element element : courseList) {
                Object courseName = JXDocumentUtil.getInfoByJXDocument(new JXDocument(element.html()), "//a[@class='react ']/@title");
                Object img = JXDocumentUtil.getInfoByJXDocument(new JXDocument(element.html()), "//div[@class='dealcard-img imgbox']/@data-src-high");
